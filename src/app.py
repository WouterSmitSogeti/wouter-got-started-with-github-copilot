...
activities = {
    ...
    "Tennis Club": {
        "description": "Learn tennis skills and compete with other students",
    ...
    "Drama Club": {
        "description": "Theater productions and dramatic performance workshops",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Check if student is not already signed up
